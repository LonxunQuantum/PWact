from utils.constant import DFT_STYLE, VASP, PWMAT, CP2K, \
    ELEMENTTABLE_2, ELEMENTTABLE
from utils.file_operation import link_file, merge_files_to_one, write_to_file, copy_file, file_read_last_line, del_file
from utils.app_lib.pwmat import set_etot_input_by_file
import os
from data_format.configop import get_atom_type, read_cp2k_xyz
from utils.app_lib.cp2k import make_cp2k_input, make_cp2k_input_from_external
'''
description: 
